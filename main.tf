...
resource "azurerm_role_assignment" "subscription_owners" {
  ...
  principal_id         = azuread_group.subscription_owners[each.value].object_id
}
...
resource "azurerm_role_assignment" "subscription_contributors" {
  ...
  principal_id         = azuread_group.subscription_contributors[each.value].object_id
}
...
resource "azurerm_role_assignment" "subscription_readers" {
  ...
  principal_id         = azuread_group.subscription_readers[each.value].object_id
}
